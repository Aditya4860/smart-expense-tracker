...
export function buildGoal(values, existingId, existingCreatedAt) {
  ...
  return {
    ...
    targetAmount:        parseFloat(parseFloat(values.targetAmount).toFixed(2)),
    currentAmount:       parseFloat(parseFloat(values.currentAmount ?? 0).toFixed(2)),
    monthlyContribution: parseFloat(parseFloat(values.monthlyContribution).toFixed(2)),
