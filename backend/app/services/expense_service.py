...
class ExpenseService:
    ...
    async def get_expense(self, expense_id: str, user_id: str) -> Expense:
    ...
    async def update_expense(self, expense_id: str, user_id: str, expense_in: ExpenseUpdate) -> Expense:
