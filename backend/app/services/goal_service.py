...
class GoalService:
    ...
    async def update_goal(self, goal_id: str, user_id: str, goal_in: GoalUpdate) -> Goal:
    ...
    async def get_goal_progress(self, goal_id: str, user_id: str) -> GoalProgressResponse:
