...
class BudgetService:
    ...
    async def update_budget(self, budget_id: str, user_id: str, budget_in: BudgetUpdate) -> Budget:
    ...
    async def get_budget_utilization(self, budget_id: str, user_id: str, target_date: date) -> BudgetUtilizationResponse:
